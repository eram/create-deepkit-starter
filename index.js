...
const REPO_URL = 'https://github.com/eram/deepkit-starter.git';
...
async function main() {
    console.log('');
    info('='.repeat(60));
    info('  Deepkit Starter - Project Scaffolding Tool');
    info('='.repeat(60));
    console.log('');
    ...
    if (!projectName) {
        projectName = await prompt('Project name', 'my-deepkit-app');
    }
    ...
    const description = await prompt('Description', 'A Deepkit Framework application');
    ...
    try {
        ...
        console.log(`  ${styleText('cyan', 'npm install')}`);
        console.log(`  ${styleText('cyan', 'npm run dev')}`);
        console.log('');

        dim('Documentation:');
        console.log('  https://deepkit.io/documentation');
        console.log('  https://github.com/eram/deepkit-starter#readme');
        console.log('');
